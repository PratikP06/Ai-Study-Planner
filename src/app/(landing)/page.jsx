...
export default function HomePage() {
  ...
  return (
    <main
      className="text-[#3A4F4B] bg-gradient-to-br from-[#F0DDD6] via-[#F0EEEA] to-[#D2E0D3]/40">
        ...
        <div className="max-w-3xl space-y-8">
          ...
          <p className="text-lg text-[#6B7C78] leading-relaxed">
            An AI-powered study planner that organizes your subjects,
            tracks weak topics, and generates realistic daily plans —
            without burnout.
          </p>

          <div className="flex justify-center gap-5 pt-6 flex-wrap">
            <a
              href={user ? "/dashboard" : "/signup"}
              className="px-8 py-3 rounded-xl font-medium transition-all duration-200 shadow-[0_12px_35px_rgba(151,179,174,0.35)] hover:shadow-[0_18px_50px_rgba(151,179,174,0.45)] bg-[#97B3AE] text-white">
              {user ? "Go to Dashboard" : "Get Started"}
            </a>

            <a
              href="/planner"
              className="px-8 py-3 rounded-xl font-medium border border-[#D6CBBF] text-[#3A4F4B] hover:bg-white/40 transition-all duration-200">
              View Planner
            </a>
          </div>
        </div>
